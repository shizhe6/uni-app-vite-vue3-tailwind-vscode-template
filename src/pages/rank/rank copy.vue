  ...
  <view class="viewport">
    ...
    <view class="middle-container">
      <swiper class="swiper" @change="onSwiperChange">
        <swiper-item
          class="swiper-item"
          v-for="(tab, index) in primaryList"
          :key="index">
          <scroll-view class="secondary-nav" scroll-y>
            <view
          ...
          <scroll-view class="content" scroll-y>
            <view
              v-for="(book, bookIndex) in bookList"
              :key="bookIndex"
              class="book-item">
              <view
...
const onSwiperChange = (e: any) => {
  activePrimary.value = e.detail.current
}
...
.viewport {
  ...
  .top-tabs {
    display: flex;
    justify-content: flex-start; /* 改为左对齐，配合滚动 */
